...
def test_mult():
    cfg = OmegaConf.create(
        {"a": 3, "b": 2, "mult_ref": "${mult:${a},${b}}", "mult": "${mult:3,2}"}
    )
...
def test_div():
    cfg = OmegaConf.create(
        {"a": 3, "b": 2, "div_ref": "${div:${a},${b}}", "div": "${div:3,2}"}
    )
...
def test_intdiv():
    cfg = OmegaConf.create(
        {"a": 3, "b": 2, "intdiv_ref": "${intdiv:${a},${b}}", "intdiv": "${intdiv:3,2}"}
    )
...
def test_add():
    cfg = OmegaConf.create(
        {"a": 3, "b": 2, "add_ref": "${add:${a},${b}}", "add": "${add:3,2}"}
    )
...
def test_sub():
    cfg = OmegaConf.create(
        {"a": 3, "b": 2, "sub_ref": "${sub:${a},${b}}", "sub": "${sub:3,2}"}
    )
